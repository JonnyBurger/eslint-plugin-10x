 ...
 * @returns {boolean}
 */
export function isFragment(node, reactPragma, fragmentPragma): boolean {
 ...
 */
export function isJSX(node): boolean {
 ...
 * @returns {boolean}
 */
export function isJSXAttributeKey(node): boolean {
	return (
 ...
 * @returns {boolean}
 */
export function isWhiteSpaces(value): boolean {
